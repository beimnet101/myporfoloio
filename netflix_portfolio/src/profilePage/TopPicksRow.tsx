...
import { FaPassport, FaCode, FaBriefcase, FaProjectDiagram, FaEnvelope, FaMusic, FaBook } from 'react-icons/fa';
...
const topPicksConfig = {
  recruiter: [
    ...
    { title: "Published Projects", imgSrc: "https://picsum.photos/seed/projects/250/200", icon: <FaProjectDiagram />, route: "/projects" },
  ...
  developer: [
    ...
    { title: "Published Projects", imgSrc: "https://picsum.photos/seed/development/250/200", route: "/projects", icon: <FaProjectDiagram /> },
  ...
  stalker: [
    ...
    { title: "Published Projects", imgSrc: "https://picsum.photos/seed/planning/250/200", route: "/projects", icon: <FaProjectDiagram /> },
  ...
  adventure: [
    ...
    { title: "Published Projects", imgSrc: "https://picsum.photos/seed/innovation/250/200", route: "/projects", icon: <FaProjectDiagram /> },
