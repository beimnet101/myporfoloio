...
import './Music.css';
import albumCover1 from '../images/download.jpg'; // Hotel California by The Eagles
import albumCover2 from '../images/download2.jpg'; // Back in Black by AC/DC
...
const favoriteAlbums = [
  { title: "The ChainSmokers", artist: "chainsmokers", imgSrc: albumCover1 },
  { title: "DeBÍ TiRAR MáS FOToS", artist: "Bad Bunny", imgSrc: albumCover2 },
...
const Music: React.FC = () => {
  return (
    <div className="music-page">
      <div className="quote">
        <p>“pop isn’t a genre, it’s a way of life.” 🎸</p>
      </div>
